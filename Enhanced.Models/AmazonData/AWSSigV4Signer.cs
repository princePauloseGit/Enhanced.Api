...
namespace Enhanced.Models.AmazonData
{
    public class AWSSigV4Signer
    {
        ...
        public IRestRequest Sign(IRestRequest request, string host)
        {
            ...
            string stringToSign = AwsSignerHelper.BuildStringToSign(signingDate, hashedCanonicalRequest, awsCredentials.Region!);

            string signature = AwsSignerHelper.CalculateSignature(stringToSign, signingDate, awsCredentials.SecretKey!, awsCredentials.Region!);

            AwsSignerHelper.AddSignature(request, awsCredentials.AccessKeyId!, signedHeaders, signature, awsCredentials.Region!, signingDate);
    ...
    public class AWSSignerHelper
    {
        ...
        private readonly static Regex CompressWhitespaceRegex = new("\\s+");
        ...
        public virtual string ExtractCanonicalQueryString(IRestRequest request)
        {
            ...
            SortedDictionary<string, string> sortedqueryParameters = new(queryParameters);
        ...
        public virtual string ExtractCanonicalHeaders(IRestRequest request)
        {
            ...
            SortedDictionary<string, string> sortedHeaders = new(headers);
