...
namespace Enhanced.Models.AmazonData
{
    public class ParameterOrderList : ParameterBased
    {
        ...
        /// </summary>
        public IList<AmazonEnum.OrderStatus>? OrderStatuses { get; set; }
        /// <summary>
        ...
        /// </summary>
        public IList<AmazonEnum.FulfillmentChannel>? FulfillmentChannels { get; set; }
        ...
        /// </summary>
        public IList<AmazonEnum.PaymentMethod>? PaymentMethods { get; set; }

        [JsonProperty(ItemConverterType = typeof(StringEnumConverter))]
        public IList<AmazonEnum.EasyShipShipmentStatus>? EasyShipShipmentStatuses { get; set; }
        /// <summary>
    ...
    public class RestrictedDataToken
    {
        public bool IsNeedRestrictedDataToken { get; set; } = false;
    }
}
